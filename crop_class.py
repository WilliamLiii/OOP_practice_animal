...
class Crop:
    ...
    def __init__(self, growth_rate, light_need, water_need):
        ...
        #the above attributes are prefixed with an underscore to indicate that they should not be accessed directly from outside of the class
    ...
    def report(self):
        #method to report the information about the current state os crop
